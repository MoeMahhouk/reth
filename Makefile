...
install-cargo-deb: ## Install cargo-deb if not present
...
.PHONY: deb-cargo
deb-cargo: install-cargo-deb ## Build .deb package using cargo-deb with reproducible settings
...
deb-cargo-aarch64: install-cargo-deb ## Build .deb for aarch64 architecture
